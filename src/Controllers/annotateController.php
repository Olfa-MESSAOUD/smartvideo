...
class annotateController extends Controller
{
    ...
    $post_data = annotateController::formData($request);
    ...
    public function list()
    {
        ...
        {
          if(Str::contains($statement, 'annotated'))
	...
	public function formData(Request $request)
	{
		...
		$data = [
            'verb' => [
                'id' => 'http://smartvideo.fr/xapi/verbs/annotated',
                'display' => [
                    'en-US' => 'annotated'
                ],
            ],
            ...
            'context' => [
                'extensions' => [
                    "https://smartvideo.fr/xapi/extensions/comment" => $request->comment
                ]
            ],
