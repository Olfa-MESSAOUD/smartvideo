...
class likeController extends Controller
{
    public function create(Request $request)
    {
      $request->validate([
        ...
        $post_data = likeController::formData($request);
    ...
    public function list()
    {
        ...
        {
          if(Str::contains($statement, 'liked'))
  ...
  public function destroy($id)
  {
	...
	public function formData(Request $request)
	{
		...
		'verb' => [
			'id' => 'https://smartvideo.fr/xapi/verbs/liked',
			'display' => [
				'en-US' => 'liked'
			],
		],
		...
		'context' => [
			'extensions' => [
                "https://smartvideo.fr/xapi/extensions/value" => $request->value
                ]
        ],
